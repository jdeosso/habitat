...
def calculo(df_fondos, df_valores, restriccion, Administradora):
        ...
        df_lista_t = pd.DataFrame(
            {
                ...
                "RUN": ["{}-A".format(Administradora)],
                "Serie": ["Obl"],
                "por": [100],
                "NombreFondo": ["{}-A".format(Administradora)],
            }
        )
        df_lista = df_lista.append(df_lista_t)
    ...
    df_lista_t = pd.DataFrame(
        {
            "simulacion": df_lista["simulacion"].max() + 1,
            "RUN": ["{}-E".format(Administradora)],
            "Serie": ["Obl"],
            "por": [100],
            "NombreFondo": ["{}-E".format(Administradora)],
        }
    )
    df_lista = df_lista.append(df_lista_t)
    df_lista_t = pd.DataFrame(
        {
            "simulacion": df_lista["simulacion"].max() + 1,
            "RUN": ["{}-C".format(Administradora)],
            "Serie": ["Obl"],
            "por": [100],
            "NombreFondo": ["{}-C".format(Administradora)],
        }
    )
    df_lista = df_lista.append(df_lista_t)
    df_lista_t = pd.DataFrame(
        {
            "simulacion": df_lista["simulacion"].max() + 1,
            "RUN": ["{}-B".format(Administradora)],
            "Serie": ["Obl"],
            "por": [100],
            "NombreFondo": ["{}-B".format(Administradora)],
        }
    )
    df_lista = df_lista.append(df_lista_t)
    df_lista_t = pd.DataFrame(
        {
            "simulacion": df_lista["simulacion"].max() + 1,
            "RUN": ["{}-D".format(Administradora)],
            "Serie": ["Obl"],
            "por": [100],
            "NombreFondo": ["{}-D".format(Administradora)],
        }
    )
    df_lista = df_lista.append(df_lista_t)
...
if __name__ == "__main__":
    ...
    file_optimo = "/var/www/habitat/data/optimo-{}.json".format(Administradora.lower())
    file_instrumentos = "/var/www/habitat/data/instrumentos.json"

    df_Fondos = pd.DataFrame(
        data={
            "RUN": [
                "{}-A".format(Administradora),
                "{}-B".format(Administradora),
                "{}-C".format(Administradora),
                "{}-D".format(Administradora),
                "{}-E".format(Administradora),
            ],
