...
file_optimo = '../../data/optimo_vol.json'
...
def calculo(df_fondos,df_valores,restriccion):
    ...
    if restriccion==0:
        df_lista_t=pd.DataFrame({'simulacion':df_lista['simulacion'].max()+1,'RUN':['HABITAT-A'],'Serie':['Obl'],'por':[100],'NombreFondo':['HABITAT-A']})
        df_lista=df_lista.append(df_lista_t)
        
    df_lista_t=pd.DataFrame({'simulacion':df_lista['simulacion'].max()+1,'RUN':['HABITAT-E'],'Serie':['Obl'],'por':[100],'NombreFondo':['HABITAT-E']})
    df_lista=df_lista.append(df_lista_t)
    df_lista_t=pd.DataFrame({'simulacion':df_lista['simulacion'].max()+1,'RUN':['HABITAT-C'],'Serie':['Obl'],'por':[100],'NombreFondo':['HABITAT-C']})
    df_lista=df_lista.append(df_lista_t)
    df_lista_t=pd.DataFrame({'simulacion':df_lista['simulacion'].max()+1,'RUN':['HABITAT-B'],'Serie':['Obl'],'por':[100],'NombreFondo':['HABITAT-B']})
    df_lista=df_lista.append(df_lista_t)
    df_lista_t=pd.DataFrame({'simulacion':df_lista['simulacion'].max()+1,'RUN':['HABITAT-D'],'Serie':['Obl'],'por':[100],'NombreFondo':['HABITAT-D']})
    df_lista=df_lista.append(df_lista_t)
    ...
    for j in range(1,int(df_lista['simulacion'].max()+1)):
        ...
        df_resultado=df_resultado.append(df_temp)    
    ### matriz volatilidad
    df_volatilidad=pd.DataFrame(data={'vol_hasta':[0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 2.25, 2.5, 2.75, 3, 3.25, 3.5, 3.75, 4, 4.25, 4.5, 4.75, 5, 5.25, 5.5, 5.75, 6, 6.25, 6.5, 7, 7.5, 100],'vol_desde':[0,0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 2.25, 2.5, 2.75, 3, 3.25, 3.5, 3.75, 4, 4.25, 4.5, 4.75, 5, 5.25, 5.5, 5.75, 6, 6.25, 6.5, 7, 7.5]})
    df_volatilidad['vol_desde']=df_volatilidad['vol_desde']/100
    df_volatilidad['simulacion']=0
    df_volatilidad['ren_max']=0
    df_volatilidad['vol_hasta']=df_volatilidad['vol_hasta']/100
    
    df_volatilidad1=pd.DataFrame(data={'vol_hasta':[0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 2.25, 2.5, 2.75, 3, 3.25, 3.5, 3.75, 4, 4.25, 4.5, 4.75, 5, 5.25, 5.5, 5.75, 6, 6.25, 6.5, 7, 7.5, 100],'vol_desde':[0,0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 2.25, 2.5, 2.75, 3, 3.25, 3.5, 3.75, 4, 4.25, 4.5, 4.75, 5, 5.25, 5.5, 5.75, 6, 6.25, 6.5, 7, 7.5]})
    
    df_volatilidad1['simulacion']=0
    df_volatilidad1['ren_max']=0
    df_volatilidad1['vol_hasta']=df_volatilidad1['vol_hasta']/100
    df_volatilidad1['vol_desde']=df_volatilidad1['vol_desde']/100
    ...
    for index1, row1 in df_volatilidad.iterrows():
        df_resultado_sal=df_resultado1[((df_resultado1['vol']<=row1['vol_hasta']) & (df_resultado1['vol']>row1['vol_desde']))]
...
if __name__== "__main__":
    ...
    df_Fondos=pd.DataFrame(data={'RUN':['HABITAT-A','HABITAT-B','HABITAT-C','HABITAT-D','HABITAT-E'],'Serie':['Obl','Obl','Obl','Obl','Obl']})
    ...
    df_Fondos=pd.DataFrame(data={'RUN':['HABITAT-B','HABITAT-C','HABITAT-D','HABITAT-E'],'Serie':['Obl','Obl','Obl','Obl']})
