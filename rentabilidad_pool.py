...
#### parametros entrada
#lista = [['PLANVITAL-C','APV','90'],['PLANVITAL-D','APV','10']]
...
def get_df(fname):
    return dd.read_csv(fname, dtype={'tipo_cambio': 'float64'},usecols =['RUN','Serie','valor_cuota','Fecha','uf','tipo_cambio','tac_total']).compute()
